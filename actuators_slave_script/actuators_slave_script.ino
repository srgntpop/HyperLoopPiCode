...
void requestEvent() {
  ...
  writeString(distanceSilver0str);
  writeString(distanceSilver1str);
  writeString(distanceBlack0str);
  writeString(distanceBlack1str);
  writeString(distanceBlack2str);
  writeString(distanceBlack3str);
